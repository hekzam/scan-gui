...
{
  QStringList const nomsFichiers =
      QFileDialog::getOpenFileNames(boundaryWindow, ("Open files"),
                                    "/Users/marcomartins/My Documents /Licence "
                                    "Informatique L3/Bureau d'Étude/QT/Proto",
                                    "*.*");
