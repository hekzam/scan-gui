...
void FieldViewTable::insertPage(int& line, SubjectInfo& subject, CopyInfo& copy, PageInfo& page){
    if (!page.getPageInJSON()){ //This will occur if a selected page was not mentionned in any JSON file
        ...
        QString fileError = "The file : " + copy.getCopyName() + "-" + page.getPageName()  + " is not associated with any JSON file.";
        addErrors(fileError);
    }
        ...
        QString fileError = "The file : " + copy.getCopyName() + "-" + page.getPageName()  + " was specified in a JSON file but was not selected.";
        addErrors(fileError);
    }
    else{
...
void FieldViewTable::insertCopy(int& line, SubjectInfo& subject, CopyInfo& copy){
    if (!copy.getCopyInJSON()){ //This will occur if a selected page was not mentionned in any JSON file
        ...
        QString fileError = "The file : " + subject.getSubjectName() + "-" + copy.getCopyName()  + " is not associated with any JSON file.";
        addErrors(fileError);
    }
        ...
        QString fileError = "The file : " + subject.getSubjectName() + "-" + copy.getCopyName()  + " was specified in a JSON file but was not selected.";
        addErrors(fileError);
    }
    else{
